...
import shabnambano from "../assets/shabnambano.jpg";
...
function Hero() {
    ...
    <div className="w-full bg-white md:h-[140%] py-0 ">
      <div className="relative w-full min-h-screen">
        <div className="absolute left-0 md:h-full w-full md:w-[25%] bg-gray-400 shadow-black">
           Shabnam Bano – MERN Stack Developer
        </div>

        <div className="absolute md:left-20 w-full md:top-10 max-w-5xl py-10">
            ...
            <div className="flex flex-row w-2/2 bg-amber-50 max-h-1/1">
              ...
              <div className="flex flex-col gap-20 items-center mx-auto p-9 bg-white min-w-2/3 min-h-7">
               ...
               Shabnam Bano – MERN Stack Developer
                ...
                <p>Shabnam Bano is a dedicated MERN Stack Developer with strong skills in MongoDB, Express.js, React.js, and Node.js. She has worked on projects like Library Management System and Smart Attendance System, focusing on clean UI, REST APIs, CRUD operations, and full-stack integration. Currently pursuing MCA, she aims to grow as a skilled Full Stack Developer and contribute to impactful web solutions.</p>
  ...
  <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row items-start justify-between gap-4 w-full">
    ...
    <div className="flex gap-6">
      <a
        href="shabnambnao527@gmail.com"
        className="hover:text-blue-400 transition"
      >
        Email
      </a>
      <a
        href="https://github.com/shabnamapsu  "
        target="_blank"
        rel="noreferrer"
        className="hover:text-blue-400 transition"
      >
      ...
      <a
        href="https://www.linkedin.com/in/shabnam-bano-3a2888311"
        target="_blank"
        rel="noreferrer"
        className="hover:text-blue-400 transition"
      >
